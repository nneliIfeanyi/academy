    ...
    <div class="container">
        <div class="row mb-5 text-center">
            <div class="col-12 text-container">
                ...
                <a href="<?php echo URLROOT; ?>/apply/<?php echo $data['param']; ?>" class="btn btn-primary text-uppercase">
        ...
        <div class="col-12">
            <div class="invitation-bg text-center py-6 rounded-5">
                <div class="text-white w-75 m-auto">
                    ...
                    <a href="<?php echo URLROOT; ?>/apply/<?php echo $data['param']; ?>" class="btn btn-primary btn-lg">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <?php if (!empty($course->curriculum)) : ?>
                                    <a href="<?php echo URLROOT; ?>/apply/<?php echo $data['param']; ?>" class="btn btn-outline-dark"><i class="fa fa-download"></i> Download Curriculum</a>
                                <?php endif; ?>
                                <a href="<?php echo URLROOT; ?>/apply/<?php echo $data['param']; ?>" class="btn btn-primary">Enroll &nbsp;<i class="fa fa-chevron-right"></i></a>
                            </div>
        ...
        <div class="row">
            <div class="col-md-6 col-lg-4">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="list-group-item  d-flex">
                        <a href="https://wa.me/2349127324517"><i class="fab fa-whatsapp me-3"></i></a>
                        <p style="font-size: 12px;">09127324517</p>
                    </li>
            ...
            <div class="col-md-6 col-lg-4">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="<?php echo URLROOT; ?>/apply/<?php echo $data['param']; ?>">Enroll</a></li>
