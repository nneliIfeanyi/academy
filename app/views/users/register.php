  ...
  <div class="row">
    <div class="col-md-6 mx-auto">
      <div class="card card-body bg-light my-5 py-5">
        ...
        <hr />
        <p class="text-center">Based on your selected course of interest, paying online before <strong>resumption date </strong> will attract a discount of <strong><?php echo $data['course']->discount; ?></strong> instead of <strong class="text-danger" style="text-decoration: line-through;"><?php echo $data['course']->price; ?></strong> click <a href="<?php echo $data['course']->paylink; ?>">here</a> to proceed. <a href="<?php echo URLROOT; ?>/users/register/later">I will do this later.</a></p>
